"""
    This is a program that prompts the user to enter the weight and price
    of two different packages of rice , then compares the cost of two packages and displays the
