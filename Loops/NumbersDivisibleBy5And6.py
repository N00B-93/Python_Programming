"""
    This is a program that displays, ten numbers
...
for number in range(100, 1001):
    # Checks if the number is divisible by 5 and 6. If so, the number is printed followed by a space and the counter variable is incremented.
