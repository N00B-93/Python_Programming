...
# Terminates the program if the number of students entered is < 2.
...
for i in range(0, numberOfStudents):
    ...
    if score > maxScore:
        # Assign secondMaxScore to current value of MaxScore if score > the highest score.
        secondMaxScore = maxScore
        # Assign score to the highest score if score > the highest score.
        maxScore = score
